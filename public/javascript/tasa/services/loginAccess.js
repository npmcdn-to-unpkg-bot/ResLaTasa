...
var loginAccess = (function () {
    function loginAccess(http) {
        this.http = http;
        this.endPoint = 'https://l7cti0d4j1.execute-api.us-east-1.amazonaws.com/deviva/post/tasa_prestatario_login';
    }
    loginAccess.prototype.access = function (body) {
        return this.http.post(this.endPoint, JSON.stringify(body))
            .map(this.extractData)
            .catch(this.handleError);
    };
    loginAccess.prototype.extractData = function (res) {
    ...
    loginAccess.prototype.handleError = function (error) {
        console.error(error);
